  ...
  factory: function (require) {
    ...
    function FilePickerMenu(props) {
      ...
      function insertFile(ref) {
        ...
        try {
          // Plain-text backfill: keep the leading "@" and append the full
          // relative path plus a single trailing space. The trailing space
          // ends the "@" input trigger (a "@" immediately followed by a space
          // does not open the picker), so typing after it continues normally.
